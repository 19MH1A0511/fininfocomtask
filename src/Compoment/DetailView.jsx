...
const DetailView = ({ onClose, restaurant }) => {
    ...
    console.log("ddddddddddddddddddddddddd", restaurant);
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex flex-col z-50 overflow-hidden">
                    ...
                    <div className="flex overflow-x-auto gap-3 pb-4 border-b">
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`flex-shrink-0 px-6 py-3 rounded-full font-medium text-sm transition ${activeCategory === cat
                                        ? 'bg-black text-white'
            ...
            {showPickup && (
                ...
                <PickUpView
                    ...
                    onSchedule={(info) => {
                        console.log('Scheduled pickup:', info);
                        // save to cart context, state, etc.
                        setShowPickup(false);
                    }}
                />
                </>
